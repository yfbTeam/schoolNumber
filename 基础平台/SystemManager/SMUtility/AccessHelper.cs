...
namespace SMSUtility
{
    ...
    public class AccessHelper
    {
        ...
        public AccessHelper(string conString)
        {
            try
            {
                conn = new OleDbConnection(conString);
        ...
        public AccessHelper()
        {
            try
            {
                string path = System.AppDomain.CurrentDomain.BaseDirectory + "\\Data\\weiXinData.mdb";
                this.conString = "Provider=Microsoft.Jet.OLEDB.4.0;Jet OLEDB:Database Password=cnnho!@#;Data Source=" + path;
