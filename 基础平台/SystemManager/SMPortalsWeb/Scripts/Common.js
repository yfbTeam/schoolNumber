WebServiceUrl = "http://localhost:28771/";
WebPushUrl = "http://localhost:28692/";
//WebServiceUrl = "http://61.50.119.70:7777";//服务器地址
CallbackName = "jsoncallback";//Ajax回调名称
SystemKey = "baseplat_self";
InfKey = "allpower";
...
function ChangeUseStatus(obj, itemid, status, tablename) {
    if (itemid != null && itemid != "") {
        jQuery.ajax({
            url: WebServiceUrl + "/Common/CommonFunction.asmx/ChangeUseStatus?",//random" + Math.random(),//方法所在页面和方法名
            type: "POST",
