<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolManager.aspx.cs" Inherits="SMWeb.School.SchoolManager" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${Email}</td>  
            <td>
                <input type="button" class="Topic_btn" value="编辑" onclick="javascript: OpenIFrameWindow('编辑学校', 'SchoolEdit.aspx?itemid=${Id}', '560px', '470px');" />
                <input type="button" class="Topic_btn" value="删除" onclick="javascript: DeleteSchool('${Id}')" />
            </td>
        </tr>
        ...
        <div class="Teaching_plan_management">
            ...
            <div class="Operation_area">
                ...
                <div class="right_add fr">
                    <a class="add" href="javascript:void(0);" onclick="javascript: OpenIFrameWindow('新增学校','SchoolEdit.aspx', '560px', '470px');"><i class="iconfont">&#xe726;</i>新增学校</a>
                </div>
            </div>
