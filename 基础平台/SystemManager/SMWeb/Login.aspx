<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SMWeb.Login" %>
...
<head>
    ...
    <style type="text/css">
        ...
        .header_wrap{width:100%;height:114px;border-top:6px solid #23A0F0;position:fixed;top:0;left:0;}
        .header{width:1200px;margin:0 auto;}
        .footer_wrap{width:100%;height:120px;background:url(images/footer_bg.png) repeat-x;position:fixed;bottom:0;left:0;}
        ...
        .footer_right p {
         ...
         .content{width:100%;position:fixed;top:120px;bottom:120px;background:url(images/content_02.png) no-repeat center top;background-size:cover;}
...
<script>
    ...
    $(document).ready(function () {
        ...
        document.getElementById("txt_loginName").value = "admin";//测试用
        document.getElementById("txt_passWord").value = "yfb@123";//测试用
        document.getElementById("inpCode").value = code;//测试用
    ...
    function OnSuccessLogin(json) {
        var cookie = json.result.retData;
        if (json.result.errNum == "0") {
            $.cookie('LoginCookie', cookie);
            location.href = "Index.aspx";
        } else {
            //layer.msg("抱歉，您的账号已被禁用！");
            layer.msg("账号密码错误！");
            //createCode();//刷新验证码
        }
    }
