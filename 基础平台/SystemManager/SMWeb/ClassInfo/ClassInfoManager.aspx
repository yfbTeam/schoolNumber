<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassInfoManager.aspx.cs" Inherits="SMWeb.ClassInfo.ClassInfoManager" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${ClassName}</td>
            <td>${ClassNO}</td>
            <td>${ClassWL(CultureScienceType)}</td>
            <td>
                <input type="button" class="Topic_btn" value="编辑" onclick="javascript: OpenIFrameWindow('编辑班级', 'ClassInfoEdit.aspx?itemid=${Id}', '560px', '600px');" />
        ...
        <div class="Teaching_plan_management">
            ...
            <div class="Operation_area">
                ...
                <div class="right_add fr">
                    <a class="add" href="javascript:void(0);" onclick="javascript: OpenIFrameWindow('新增班级','ClassInfoEdit.aspx', '560px', '600px');"><i class="iconfont">&#xe726;</i>新增班级</a>
                </div>
            </div>
