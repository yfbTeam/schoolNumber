<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherEdit.aspx.cs" Inherits="SMWeb.Teacher.TeacherEdit" %>
                        ...
                        <div class="t_message">
                            <div class="message_con">
                                <form>
                                    <table class="m_top">
                                        <tr>
                                            <td class="mi"><span class="m">教师名称：</span></td>
                                            <td class="ku">
                                        ...
                                        <tr>
                                            <td class="mi"><span class="m">工号：</span></td>
                                            <td class="ku">
                                                <input id="JobNumber" type="text" class="hu"/></td>
                                        </tr>  
                                        <tr>
...
<script type="text/javascript">
    ...
    function Save() {
        ...
        var Id = $("#hid_Id").val();
        var func = Id != "" ? "UpdateTeacher" : "AddTeacher";
        $.ajax({
            url: "/Common.ashx",
            type: "post",
            async: false,
