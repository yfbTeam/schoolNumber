<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeManager.aspx.cs" Inherits="SMWeb.Grade.GradeManager" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${PeriodName}</td>
            <td>
                <input type="button" class="Topic_btn" value="编辑" onclick="javascript: OpenIFrameWindow('编辑年级', 'GradeEdit.aspx?itemid=${Id}', '560px', '300px');" />
        ...
        <div class="Teaching_plan_management">
            ...
            <div class="Operation_area">
                ...
                <div class="right_add fr">
                    <a class="add" href="javascript:void(0);" onclick="javascript: OpenIFrameWindow('新增年级','GradeEdit.aspx', '560px', '300px');"><i class="iconfont">&#xe726;</i>新增年级</a>
                </div>
            </div>
