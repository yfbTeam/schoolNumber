<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportStudent.aspx.cs" Inherits="SMWeb.Student.ImportStudent" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#uploadify1").uploadify({
                ...
                'uploader': WebServiceUrl + 'StudentHandler.ashx',
                'formData': { Func: "UploadStudentExcel" }, //参数
    ...
    <form id="form1" enctype="multipart/form-data" method="post" runat="server">
        ...
        <div style="background: #fff; height: 215px;">
            <div style="width: 258px;  overflow: hidden; margin: 0px auto; position: relative; top: 20px;" class="select_face">
                <span >如果没有模板，需要先<a href="../Temp/StudentInfo.xlsx" style="color:red;">下载模板</a>，<br />填好数据后进行导入</span>
            </div>
