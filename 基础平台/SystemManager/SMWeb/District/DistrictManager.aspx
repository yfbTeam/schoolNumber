<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistrictManager.aspx.cs" Inherits="SMWeb.District.DistrictManager" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${CreateTime}</td>
            <td>
                <input type="button" class="Topic_btn" value="编辑" onclick="javascript: OpenIFrameWindow('区县版本', 'DistrictEdit.aspx?itemid=${Id}', '560px', '200px');" />
        ...
        <div class="Teaching_plan_management">
            ...
            <div class="Operation_area">
                ...
                <div class="right_add fr">
                    <a class="add" href="javascript:void(0);" onclick="javascript: OpenIFrameWindow('新增区县','DistrictEdit.aspx', '560px', '200px');"><i class="iconfont">&#xe726;</i>新增区县</a>
                </div>
            </div>
