...
<head>
    ...
    <script type="text/x-jquery-tmpl" id="Answer_tr">
        <tr>
            <td><a onclick="EnterDetail('${EnName}')">${EnName}</a></td>
            <td>${JobName}</td>
            <td>${CreateTime}</td>
...
<body>
    ...
    <script>
        ...
        function EnterDetail(EnterName) {
            OpenIFrameWindow('企业详情', '/Recommended/EnterpriseDetial.aspx?EnterName=' + encodeURI(EnterName), '750px', '280px');
