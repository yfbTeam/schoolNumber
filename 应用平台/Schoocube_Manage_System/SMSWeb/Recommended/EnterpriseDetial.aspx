<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseDetial.aspx.cs" Inherits="SMSWeb.Recommended.EnterpriseDetial" %>
...
<body>
    ...
    <div class="pt90 width pb10 none">
    ...
    <div id="NoEnterprise" style="display: none">
        <div class="onlinetest_item width" style="width: 600px">
    ...
    <script>
        ...
        function BindEnter(startIndex, pageSize) {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    "PageName": "Recommended/Recommended.ashx", "Func": "GetEnterList", PageIndex: startIndex, pageSize: pageSize, "Name": decodeURI(UrlDate.EnterName)
                },
     ...
     "<span class=\"comment_name\">" + this.CreateName + "</span><span class=\"comment_time\">" + this.CreateTime + "</span></div><div class=\"comment_desc\">" + this.Contents + "</div></div></div></li>");
        ...
        function AddEnterprise() {
            OpenIFrameWindow('添加企业', '/Recommended/AddEnterprise.aspx', '350px', '480px');
        }
        //添加岗位
        function AddEnterJob(EnterID) {
            OpenIFrameWindow('添加岗位', '/Recommended/AddEnterJob.aspx?EnterID=' + EnterID, '350px', '350px');
        }
        //删除岗位信息
