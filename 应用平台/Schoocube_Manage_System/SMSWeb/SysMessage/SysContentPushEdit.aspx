<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysContentPushEdit.aspx.cs" Inherits="SMSWeb.SysMessage.SysContentPushEdit" %>
            ...
            <div class="newcourse_dialog_detail">
                <div class="clearfix">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="course_form_div clearfix">
                            <label for="">内容：</label>
                            <textarea placeholder="内容" class="text" id="editor_id"></textarea>
                            <i class="stars"></i>
                        </div>
                        <div class="course_form_div clearfix">
                                ...
                                <div class="statusBar" style="display: none;">
                                    ...
                                    <div class="btns">
                                        <div id="filePicker2" class="webuploader-container">
                                            <div class="webuploader-pick none"></div>
                                            <div id="rt_rt_1alshdmp81p491fmtnlh29msgf6" style="position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden;" class="none">
                                                <input type="file" name="file" class="webuploader-element-invisible" multiple="multiple" accept="image/*" /><label style="opacity: 0; width: 100%; height: 100%; display: block; cursor: pointer; background: rgb(255, 255, 255);"></label>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            uploader = WebUploader.create({
                ...
                formData: { action: "UploadImgForNoticeShowBg" },
                fileNumLimit: 1,//上传个数
        ...
        $(function () {
            ...
            $("#btnDelShowImg").click(function () {
                $.ajax({
                    ...
                    async: false,
                    dataType: "json",
                    data: { PageName: "PortalManage/NoticesHandler.ashx", Func: "UpdateNotice", Id: $("#NoticeId").val(), ShowImgUrl: "" },
            ...
            $.ajaxFileUpload(
                {
                    ...
                    dataType: 'json',
                    data: { action: "UploadImgForMessageContent" },
                        ...
                        if (json.result.status == "ok") {
                            ...
                            if (items != null && items.length > 0) {
                                ...
                                if (dtJson != null) {
                                    ...
                                    if (item.ShowImgUrl != null && item.ShowImgUrl != "" && item.ShowImgUrl.length > 0) {
                                        $("#ShowImgUrl").attr("src", item.ShowImgUrl);
                                        $("#showUploader").show();
                                        $("#HShowImgUrl").val(item.ShowImgUrl);
                                    } else {
                                        $("#uploader").show();
                                        $('#filePicker div:eq(1)').css({ 'position': 'absolute', 'width': '126px', 'height': '36px', 'left': '50%', 'top': '50%', 'margin-left': '-61px', 'margin-top': '-18px' });
                                    }
