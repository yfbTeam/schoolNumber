...
<head runat="server">
    ...
    <script id="tr_message" type="text/x-jquery-tmpl">
        {{if Status==0}}
            <li id="li_email${Id}">{{else}}<li class="readed" id="li_email${Id}">{{/if}}
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="HEmailID" runat="server" />
            ...
            <div class="width repository_header clearfix">
                ...
                <a class="logo fl" href="/HZ_Index.aspx">
                    ...
                    <div class="wenzi_tips fl">
                        <img src="/images/xiaoxizhongxin.png" />
                    </div>
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errMsg == "success") {
                        ...
                        $("#tr_message").tmpl(items).appendTo("#tb_message");
