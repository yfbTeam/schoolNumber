<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuIndex.aspx.cs" Inherits="SMSWeb.IFramePage.StuIndex" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <header class="repository_header_wrap manage_header">
        <div class="width repository_header clearfix">
            ...
            <nav class="navbar menu_mid fl">
                <ul>
                    <li class="active"><a  href="#" onclick="ChangeSrc('http://flytsp:47039/sites/Teacher/SitePages/StudentGrowth.aspx',this,'passport')">学生成长</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="myexam bordshadrad width" style="padding:0px;">
            ...
            <div class="mycourse">
                <iframe src="http://flytsp:47039/sites/Teacher/SitePages/StudentGrowth.aspx" width="100%" height="1200px" id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no" ></iframe>
            </div>
        </div>
    </div>
    <!--预览试卷-->
