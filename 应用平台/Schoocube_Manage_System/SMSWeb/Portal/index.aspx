...
<head runat="server">
    ...
    <style>
       ...
       .scroll-pane
        ...
        .h-ico {
            display: inline-block;
            width:20px;height:20px;top:2px;left:0px;position:absolute;
        }
        #resourcelist li{position:relative;}
        #resourcelist li a{margin-left:25px;}
    </style>
    ...
    <script id="item_SchoolStyle" type="text/x-jquery-tmpl">
        <a href="/Portal/about/BeforeView.aspx?ssid=${Id}&id=${MenuId}">
            <i>{{if ImageUrl==""}}
                <img src="/PortalImages/defaultimg.jpg" />
                {{else}}
                  <img src="${ImageUrl}" />
    ...
    <script id="item_Resource" type="text/x-jquery-tmpl">
        <li class="clearfix">
            <span class="ico-${showHouzhui(postfix)}-min h-ico"></span>
           <a download="${FileUrl}"  href="${FileUrl}" class="fl text">${NameLengthUpdate(Name,10)}${postfix}</a>
        </li>
    </script>
...
<body>
    <form id="form1" runat="server">
        ...
        <a href="/Portal/Agreement.aspx" target="_blank" style="display:none"><span id="PostAgree">666</span> </a>
        <div class="top">
        ...
        <iframe name="htmlHeader" src="/Portal/header.aspx" scrolling="no" allowtransparency="true" frameborder="no" width="100%" height="460px"></iframe>
            ...
            <div class=" main_left fl">
                ...
                <div class="left_con  clearfix">
                    <div class="modult_title">
                        ...
                        <a href="/Portal/about/BeforeList.aspx?id=12" class="more fr">更多+
                        </a>
                    </div>
            ...
            <div class="main_right fr">
                <div class="right_con">
                    ...
                    <div class="right_content right_content1">
                        ...
                        <a  href="/Portal/WebEntered/index.aspx" class="online_baoming">在线报名
                        </a>
                    </div>
                </div>
        ...
        <!--footer-->
        <iframe name="htmlFoot" src="/Portal/bottom.aspx" scrolling="no" allowtransparency="true" frameborder="no" width="100%" height="175px"  style="margin-top:20px;" id="htmlFoot" ></iframe>
                    ...
                    success: function (json) {
                        if (json.result.errNum.toString() == "0") {
                            ...
                            if (items != null && items.length > 0) {
                                ...
                                $("#hrefsStyle").attr("href", "/Portal/about/BeforeView.aspx?ssid=" + items[0].Id + "&id=" + items[0].MenuId);
