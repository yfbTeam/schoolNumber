<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeforeItemList.aspx.cs" Inherits="SMSWeb.Portal.about.BeforeItemList" %>
...
<head runat="server">
    ...
    <script type="text/x-jquery-tmpl" id="tr_data">
        <li class="clearfix">
            <div class="r-s fl">
                <h3 class="n"><a href="BeforeView.aspx?advId=${Id}&id=${MenuId}">${Description}</a></h3>
                <p>${DateTimeConvert(CreateTime)}</p>
            </div>
        </li>
    </script>
