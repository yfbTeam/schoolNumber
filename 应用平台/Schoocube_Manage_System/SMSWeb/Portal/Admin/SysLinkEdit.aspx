<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysLinkEdit.aspx.cs" Inherits="SMSWeb.Portal.Admin.SysLinkEdit" %>
        ...
        $(function () {
            ...
            $("#btnDelShowImg").click(function () {
                $.ajax({
                    ...
                    async: false,
                    dataType: "json",
                    data: { PageName: "PortalManage/AdminManager.ashx", Func: "UpdateLink", Id: $("#HId").val(), ShowImgUrl: "" },
