<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceList.aspx.cs" Inherits="SMSWeb.Portal.Resource.ResourceList" %>
...
<head runat="server">
    ...
    <style>
        ...
        .h-ico {
            ...
            width:20px;height:20px;top:2px;left:0;position:absolute;
        }
    ...
    <script type="text/x-jquery-tmpl" id="tr_datagg">
        <li class="clearfix">
            <div class="docu_messages fl pr">
                <p class="docu_title "><span class="ico-${showHouzhui(postfix)}-min h-ico"></span><a class="docu_name ml25" download="${FileUrl}" href="${FileUrl}">${Name}${postfix}</a></p>
            </div>
            <div class="unload_none fl">
                <span class="upload">
                    <i class="icon icon-download-alt" title="下载"></i>
                </span>
            </div>
...
<body>
    <form id="form1" runat="server">
       ...
       <%-- <iframe name="htmlHeader" src="/headerTop.html" scrolling="no" allowtransparency="true" frameborder="no" width="100%" height="400px" style="position:absolute;top:0;left:0;z-index:0"></iframe></div>--%>
       <%--div id="htmlHeader" style="min-height:155px;"></div>--%>
        ...
        <div class="main width clearfix  mb20" style="margin-top:20px;">
            ...
            <div class="leftnav">
                <h1>
                    <span class="school_zn" id="hTitle">资源下载</span>
                    <span class="school_zy">ResourceDownLoad</span>
                </h1>
            ...
            <div class="content">
                ...
                <div class="content_detail" style="padding: 10px 0px;">
                    <ul class="skydrive_docu_list" style="display: block;" id="tb_data">
        ...
        <style>
            .skydrive_docu_list {
                ...
                .skydrive_docu_list li {
                    padding: 5px 10px;
                    border-bottom: 1px dotted rgba(0,0,0,.2);
                    position: relative;
                }

                    .skydrive_docu_list li .docu_messages {
                        width: 350px;
                    }
            ...
            .skydrive_docu_list .unload_none {
                left: 35%;
            }
        ...
        <!--footer-->
        <iframe name="htmlFoot" id="htmlFoot" src="/bottom.aspx" scrolling="no" allowtransparency="true" frameborder="no" width="100%"></iframe>
    </form>
    <script type="text/javascript">
        $(document).ready(function () {
            getUserInfoCookie();
            //$("#htmlHeader").load("/Portal/headerTop.html", function () {
            //    var js_obj = document.createElement("script");
            //    js_obj.type = "text/javascript";
            //    js_obj.setAttribute("src", "/Scripts/jquery.tmpl.js");
            //    document.head.appendChild(js_obj);
            //    getData(1, 10);
            //});
            getData(1, 10);
            //鼠标滑过显示
            $('.skydrive_docu_list li').hover(function () {
                $(this).find('.unload_none').show();
            }, function () {
                $(this).find('.unload_none').hide();
            })
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errMsg == "success") {
                        $("#tb_data").html('');
                        $("#tr_datagg").tmpl(json.result.retData.PagedData).appendTo("#tb_data");
        ...
        function leftTree() {
            var html = "<a href=\"#\" data-url=\"/Portal/Resource/ResourceList.aspx\" class=\"on\" >资源下载</a>";
            $("#div_leftTree").html(html);
            $("#aTypeMenu").html("资源下载");
            $("#aTypeMenu").attr("href", "/Portal/Resource/ResourceList.aspx");
            //$.ajax({
            //    url: "/Common.ashx",
            //    type: "post",
            //    async: false,
        ...
        function getUserInfoCookie() {
            if ($.cookie('LoginCookie_Cube') == null || $.cookie('LoginCookie_Cube') == "" || $.cookie('LoginCookie_Cube') == "null") return;
        ...
        function showHouzhui(houzhui) {
            if (houzhui != "" && houzhui!=null) {
                houzhui = houzhui.substring(1, houzhui.length);
                return houzhui;
            }
            else {
                return "file";
