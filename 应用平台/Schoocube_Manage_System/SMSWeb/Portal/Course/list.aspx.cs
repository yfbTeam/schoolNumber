...
{
    public partial class list : BaseCss
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            HMenuId.Value = Request.QueryString["id"];
            CourseName.Value = Request.QueryString["coursename"];
            HisCharge.Value = Request.QueryString["ischarge"];
            HCourseType.Value = Request.QueryString["coursetype"];
