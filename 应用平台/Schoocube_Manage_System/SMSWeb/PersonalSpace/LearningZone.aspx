<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LearningZone.aspx.cs" Inherits="SMSWeb.PersonalSpace.LearningZone" %>
...
<body>
    ...
    <div>
        ...
        <div class="space_centerwrap bordshadrad" style="padding:20px;background: #fff;">
            <div class="crumbs"><a href="/PersonalSpace/Learning_center_portal.aspx">学习中心门户</a> <span>&gt;</span><a href="/PersonalSpace/LearningZone.aspx">就业区</a></div>
            <div class="generalDom clearfix">
                <div class="generalImg fl">
                    <img width="93" height="93" src="/images/community_01.png" alt="前端">
                </div>
            ...
            <div class="community_wrap">
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="怎么clearInterval清除时间啊？？">怎么clearInterval清除时间啊？？</a>
                    ...
                    <div class="postOper font12 clearfix">
                        ...
                        <span class="color_red dislb" style="line-height: 25px;">&nbsp;&nbsp;java</span>
                ...
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="PHP 和 Java 的主要区别有哪些">PHP 和 Java 的主要区别有哪些</a>
                    ...
                    <div class="postOper font12 clearfix">
                        ...
                        <span class="color_red dislb" style="line-height: 25px;">&nbsp;&nbsp;前端</span>
                        <div class="fr" style="margin-top: 5px;">
