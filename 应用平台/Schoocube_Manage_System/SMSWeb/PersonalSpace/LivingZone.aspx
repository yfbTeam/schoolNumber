<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LivingZone.aspx.cs" Inherits="SMSWeb.PersonalSpace.LivingZone" %>
...
<body>
    ...
    <div>
        ...
        <div class="space_centerwrap bordshadrad" style="padding:20px;background: #fff;">
            <div class="crumbs"><a href="/PersonalSpace/Learning_center_portal.aspx">学习中心门户</a> <span>&gt;</span><a href="/PersonalSpace/LivlingZone.aspx">就业区</a></div>
            <div class="generalDom clearfix">
                <div class="generalImg fl">
                    <img width="93" height="93" src="/images/community_04.png" alt="前端">
                </div>
                <div class="generalInfo">
                    ...
                    <p>
                        <span class="color_grey">帖子：<i class="color_red">75</i></span>
                        <i class="color_gray">&nbsp;&nbsp;|&nbsp;&nbsp;</i>
                        <span class="color_grey">粉丝：<i class="color_red">32</i></span>
                    </p>
                </div>
            </div>
            ...
            <div class="community_wrap">
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="校园歌唱比赛正在举行中！！">校园歌唱比赛正在举行中！！</a>
                    ...
                    <div class="postOper font12 clearfix">
                        ...
                        <span class="color_red dislb" style="line-height: 25px;">&nbsp;&nbsp;生活</span>
                        <div class="fr" style="margin-top: 5px;">
                            ...
                            <span class="color_grey dislb" style="line-height: 16px;">7月28日 17:11</span>
                        </div>
                    </div>
                </div>
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="学校里帅锅是谁？">学校里帅锅是谁？</a>
                    ...
                    <div class="postOper font12 clearfix">
                        ...
                        <i class="dislb color_gray" style="line-height: 25px;">&nbsp;|&nbsp;</i>
                        <span class="dislb color_grey" style="line-height: 25px;">8月2日 11:39</span>
                        <span class="color_red dislb" style="line-height: 25px;">&nbsp;&nbsp;生活</span>
                        <div class="fr" style="margin-top: 5px;">
                            ...
                            <span class="color_grey dislb" style="line-height: 16px;">8月4日 17:11</span>
                        </div>
                    </div>
                </div>
            </div>
