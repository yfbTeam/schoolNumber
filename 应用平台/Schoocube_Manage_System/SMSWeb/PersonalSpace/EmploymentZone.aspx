<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmploymentZone.aspx.cs" Inherits="SMSWeb.PersonalSpace.EmploymentZone" %>
...
<body>
    ...
    <div>
        ...
        <div class="space_centerwrap bordshadrad" style="padding:20px;background: #fff;">
            <div class="crumbs"><a href="/PersonalSpace/Learning_center_portal.aspx">学习中心门户</a> <span>&gt;</span><a href="/PersonalSpace/EmploymentZone.aspx">就业区</a></div>
            <div class="generalDom clearfix">
                <div class="generalImg fl">
                    <img width="93" height="93" src="/images/community_03.png" alt="就业" />
                </div>
            ...
            <div class="community_wrap">
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="前端工程师如何进入Bat公司就职">前端工程师如何进入Bat公司就职</a>
                ...
                <div class="postSingle">
                    <h2 class="postTitle">
                        <a href="javascript:;" target="_blank" class="overflow titles"  title="就业面试指导">就业面试指导</a>
