    ...
    <script type="text/javascript">
        ...
        function BindStu() {
            ...
            $.ajax({
                ...
                async: false,
                dataType: "json",
                data: { "PageName": "CourseManage/CourceManage.ashx", "Func": "GetSelStu", "CourseID": UrlDate.ID, ClassID: $("#Class1").val() },
                success: function (json) {
                    if (json.result.errNum == "0") {

                        $(json.result.retData).each(function () {
                            if (this.CreateName != undefined) {
        ...
        function BindFreeStu() {
            ...
            $.ajax({
                ...
                async: false,
                dataType: "json",
                data: { "PageName": "CourseManage/CourceManage.ashx", "Func": "GetFreeStu", "CourseID": UrlDate.ID, ClassID: $("#Class2").val() },
                success: function (json) {
                    if (json.result.errNum == "0") {
                        var div = "";
                        $(json.result.retData).each(function () {
    ...
    <form id="form1" runat="server">
        ...
        <div class="onlinetest_item width pt90">
            <div class="course_manage bordshadrad">
                <div class="crumbs">
                    <a style="cursor: pointer;" onclick="javascript:window.history.go(-1)">课程管理</a>
                    <span>&gt;</span>
                ...
                <div class="enroll_allot mt10 clearfix">
                    <div class="enroll_students fl">
                        ...
                        <div class="enrollgrade_select clearfix">
                            <div class="clearfix fl course_select">
                                <label for="">班级：</label>
                                <select name="" id="Class1" class="select" onchange="BindStu()">
                    ...
                    <div class="allot_students fr">
                        ...
                        <div class="allotgrade_select clearfix">
                            <div class="clearfix fl course_select">
                                <label for="">班级：</label>
                                <select name="" id="Class2" class="select" onchange="BindFreeStu()">
                                    <option value="">请选择</option>
