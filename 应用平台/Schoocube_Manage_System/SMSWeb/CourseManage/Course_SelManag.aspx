...
<script type="text/javascript">
    ...
    //修改设置
    function Edit(ID) {
        OpenIFrameWindow('修改设置', '/CourseManage/Course_SelAdd.aspx?ID=' + ID, '380px', '420px');
    }
    function Add() {
        OpenIFrameWindow('添加设置', '/CourseManage/Course_SelAdd.aspx', '380px', '420px');
    }
    function Set(ID) {
        window.location.href = '/CourseManage/Course_SelWeek.aspx?ID=' + ID;// + "&ParentID=" + UrlDate.ParentID;
    }
</script>
</html>
