    ...
    <script id="tr_Cource" type="text/x-jquery-tmpl">
        ...
        <li class="clearfix">
            ...
            <div class="fr mycourse_mes">
                <h1 class="mycourse_name">${Name}</h1><span style="float:right">
                    <input type="button" value="导出静态课程" onclick="ExportCouse()" class="" style="top: 30px; right: 10px; float: right; position: absolute;border-radius: 3px; text-decoration: none; font-size: 14px; background-color: #1472b9; color: white; border: 0px; padding: 6px 15px; cursor: pointer;"/></span>
                <h2 class="clearfix">
...
<body>
    ...
    <script type="text/javascript">
        ...
        function ExportCouse() {
            ...
            /*$.ajax({
                url: "test.ashx",//random" + Math.random(),//方法所在页面和方法名
                type: "post",
                async: false,
                dataType: "json",
                data: {
                    "PageName": "CourseManage/CourceManage.ashx", "Func": "SortMenu",
                    tb_MyCource: encodeURIComponent($("#tb_MyCource").html()),
                    header: encodeURIComponent($(".repository_header_wrap").html()),
                    menu_side: encodeURIComponent($("#menu_side").html()),
                    coursedetail: encodeURIComponent($(".coursedetail_right").html()),
                    taolun: encodeURIComponent($("#taolun").html()),
                    biji: encodeURIComponent($("#biji").html()),
                    renwu: encodeURIComponent($("#renwu").html()),
                    zuoye: encodeURIComponent($("#zuoye").html()),
                    pingjia: encodeURIComponent($("#pingjia").html()),
                },
                success: function (json) {
                    var curindex = 0;
        ...
        function LookCourseWork_Click() {
            OpenIFrameWindow('查看学生提交作业信息', '/OnlineLearning/LookStuWorkStatistics.aspx?courseid=' + UrlDate.itemid + "&coursetype=" + $(".course_type").attr("typevalue"), '580px', '450px')
        }
