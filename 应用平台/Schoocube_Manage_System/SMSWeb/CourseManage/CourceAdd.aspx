            ...
            <div class="newcourse_dialog_detail">
                ...
                <div class="clearfix">
                    ...
                    <div class="course_form_div fl">
                        ...
                        <input type="text" placeholder="开始时间" class="text" id="StartTime" onclick="javascript: WdatePicker({ maxDate: '#F{$dp.$D(\'EndTime\')}' });" />
                    </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="course_form_div fr">
                            <label for="">课程链接：</label>
                            <input type="text" placeholder="课程链接" class="text" value="" id="CourseUrl" disabled="disabled" />
                            <i class="stars"></i>
                        </div>
                        <div style="clear: both"></div>
            ...
            if (!Name.length || StudyTerm == "0" || !LessonPeriod.length || !CoursePrice.length || !StuMaxCount.length) {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        if (result.errNum == 0) {
                            if (CourceType == "2") {
                                addSysNotice("课程审核", "新增课程【" + Name + "】待审核", 3, CreateUID, CreateUID, "321202199011239362", $("#HUserName").val(), '张丽', 0);
                            }
