<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SMSWeb.Index" %>
...
<body>
    ...
    <header class="repository_header_wrap">
        <div class="width repository_header clearfix">
            <a class="logo fl" href="HZ_Index.aspx">
               <img src="images/hzlogo.png" style="margin-top:5px;"/>
    ...
    <footer class="mt10">
        <div class="footer width clearfix">
            <div class="logo fl">
                <img src="images/hzlogo.png" style="margin-top:10px;"/>
            </div>
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        $(json.result.retData).each(function () {
                            if (this.IsOwner > 0) {
                                var li = " <li><a href=\"" + this.Url + "?ParentID=" + this.Id + "&PageName=" + this.Url
