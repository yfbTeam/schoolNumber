    ...
    <script type="text/javascript">
        ...
        function ResourceTimeMate() {
            ...
            if (Pid == null || Pid == undefined || Pid == "") {
                ...
                OpenIFrameWindow('时间匹配', '/ResourceReservations/ResourceTimeMate.aspx?PID=' + Pid + '&PName=' + PName + '&ParentID=' + UrlDate.ParentID + '&PageName=' + UrlDate.PageName, '700px', '80%');
            }
        }
        ...
        function AddResource() {
            ...
            if (Pid == null || Pid == undefined || Pid == "") {
                ...
                OpenIFrameWindow('新增资源', '/ResourceReservations/ResourceAdd.aspx?PID=' + Pid + '&PName=' + escape(PName) + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&Time=" + maxTime, '700px', '80%');
        ...
        function EditResource(id, name) {
            ...
            //var Pid = $("#HChapterID").val();
            //var PName = $("#HChapterName").val();
            OpenIFrameWindow('编辑资源', '/ResourceReservations/ResourceAdd.aspx?ID=' + id + '&PName=' + escape(name) + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName, '700px', '80%');
        }
