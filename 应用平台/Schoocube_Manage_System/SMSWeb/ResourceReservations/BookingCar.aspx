...
<body>
    ...
    <script type="text/javascript">
        ...
        function EditBookCar(obj, id, status) {
            OpenIFrameWindow('审批', '/ResourceReservations/ResourceApproval.aspx?ID=' + id + '&approvalStutus=' + status, '700px', '40%');
        ...
        function ViewBookCar(obj, id) {
            OpenIFrameWindow('预约详情', '/ResourceReservations/ViewBookCar.aspx?ID=' + id, '700px', '41%');
        }
