<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Knowledge_track2.aspx.cs" Inherits="SMSWeb.analysisa.Knowledge_track2" %>
        ...
        <div>
            ...
            <div class="onlinetest_item width pt90 pr ">
                <div class="bordshadrad" style="background: #fff; padding: 20px;">
                    ...
                    <div class="wrap">
                        <table>
                            <caption style="line-height: 40px; text-align: center; font-weight: bold;">《MySQL入门》知识点跟踪</caption>
                            <thead>
                                <tr>
                                    <th>知识点名称</th>
                                    <th>习题个数</th>
            ...
            <script>
                ...
                function initChart() {
                    var xml = '<chart caption="《MySQL入门》知识点跟踪" numberSuffix=" 个"  ><set value="2" label="100%" color="AFD8F8" /><set value="3" label="90%-99%" color="F6BD0F" /><set value="3" label="80%-89%" color="8BBA00" /><set value="5" label="70%-79%" color="AFD8F8" /></chart>';
