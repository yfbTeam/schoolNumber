        ...
        function getData(startIndex, pageSize) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    PageSize: pageSize,
                    CreateUID: UrlDate.CreateUID,
                    StuName: UrlDate.StuName
                },
                ...
                <div class="width repository_header clearfix">
                    ...
                    <nav id="teacher" class="navbar menu_mid fl">
                        <ul id="CourceMenu">
                            ...
                            <li class="active"><a href="/analysisa/study_process(4).aspx">学习进度</a></li>
