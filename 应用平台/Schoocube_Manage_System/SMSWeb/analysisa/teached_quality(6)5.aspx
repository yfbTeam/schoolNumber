<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teached_quality(6)5.aspx.cs" Inherits="SMSWeb.analysisa.teached_quality_6_5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 CG绘画培训》教学质量评价</caption>
                <thead>
                <th>姓名</th>
                <th>对老师评价</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》教学质量评价" numberSuffix=" 人"  ><set value="5" label="非常棒" color="AFD8F8" /><set value="8" label="很好" color="F6BD0F" /><set value="2" label="一般" color="8BBA00" /><set value="1" label="差" color="AFD8F8"/></chart>';
