<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledge_line_11.aspx.cs" Inherits="SMSWeb.analysisa.knowledge_line_1_1" %>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <div class="distributed fr">
                <a href="javascript:void(0);" onclick="javascript:window.open('/baobiao/《python基础》课程掌握程度.xlsx')">导出数据</a>
            </div>
            <table>
