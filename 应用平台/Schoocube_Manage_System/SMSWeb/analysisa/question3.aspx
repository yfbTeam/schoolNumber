<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="question3.aspx.cs" Inherits="SMSWeb.analysisa.question3" %>
...
<meta charset="utf-8" />
    ...
    <title>你认为初一英语上册（人教版）课程怎么样问卷调查</title>
    <!--图标样式-->
...
<body>
                ...
                <ul id="CourceMenu">
                    <li currentclass="active">
                          <li currentclass="active"><a href="/Questionnaire/Option.aspx">问卷项管理</a></li>
                            ...
                            <li currentclass="active" class="active"><a href="/analysisa/question.aspx">问卷调查统计</a></li>
                    </li>
                </ul>
            </nav>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table id="table">
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">你认为初一英语上册（人教版）课程怎么样问卷调查</caption>
                <thead>
                    <tr>
                        <th>姓名</th>
                        <th>分数</th>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="你认为初一英语上册（人教版）课程怎么样问卷调查" numberSuffix="人数" ><set value="1" label="100分" color="AFD8F8" /><set value="3" label="90-99" color="F6BD0F" /><set value="7" label="80-89" color="8BBA00" /><set value="5" label="70-79" color="AFD8F8" /></chart>';
