<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work_correction(12)5.aspx.cs" Inherits="SMSWeb.analysisa.work_correction_12_5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table id="table">
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《CG绘画培训》作业批改情况</caption>
                <thead>
                    <th>作业总次数</th>
                    <th>及时批改次数</th>
                    <th>未及时批改次数</th>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》作业批改情况" numberSuffix=" 次"  ><set value="48" label="及时批改" color="AFD8F8" /><set value="2" label="未及时批改" color="F6BD0F" /></chart>';
