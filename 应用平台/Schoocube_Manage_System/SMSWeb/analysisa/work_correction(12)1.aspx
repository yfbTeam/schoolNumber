<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work_correction(12)1.aspx.cs" Inherits="SMSWeb.analysisa.work_correction_12_1" %>
...
<script>
    function initChart() {
        var xml = '<chart caption="《python基础》作业批改情况" numberSuffix=" 次"  ><set value="48" label="及时批改" color="AFD8F8" /><set value="2" label="未及时批改" color="F6BD0F" /></chart>';
