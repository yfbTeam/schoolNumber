<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="question_answer(3)5.aspx.cs" Inherits="SMSWeb.analysisa.question_answer_3_5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table id="table">
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 CG绘画培训》答疑回复情况</caption>
                <thead>
                <th>答疑总次数</th>
                <th>及时回复次数</th>
                <th>未及时回复次数</th>
...
<script>
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》答疑回复情况" numberSuffix=" 次"  ><set value="180" label="及时回复" color="AFD8F8" /><set value="20" label="未及时回复" color="F6BD0F" /></chart>';
