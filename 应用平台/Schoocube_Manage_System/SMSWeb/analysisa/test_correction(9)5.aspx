<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_correction(9)5.aspx.cs" Inherits="SMSWeb.analysisa.test_correction_9_5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table id="table">
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《CG绘画培训》试卷批改情况</caption>
                <thead>
                <th>试卷总张数</th>
                <th>及时批改张数</th>
                <th>未及时批改张数</th>
...
<script>
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》试卷批改情况" numberSuffix=" 张"  ><set value="140" label="及时批改" color="AFD8F8" /><set value="10" label="未及时批改" color="F6BD0F" /></chart>';
