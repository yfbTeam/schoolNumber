<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledge_line_15.aspx.cs" Inherits="SMSWeb.analysisa.knowledge_line_1_5" %>
        ...
        <div class="width repository_header clearfix">
            ...
            <nav id="teacher" class="navbar menu_mid fl">
                <ul id="CourceMenu">
                    ...
                    <li currentclass="active"><a href="work_finishline(13).aspx">作业练习完成情况</a></li>
                </ul>
            </nav>
                ...
                <ul class="account_area fl">
                    ...
                    <li>
                        <a href="javascript:;" class="login_area clearfix">
                            <div class="avatar">
                                <img src="http://192.168.1.101:9005/Upload/888.png" />
                            </div>
                            <h2>胡永娣</h2>
                        </a>
                    </li>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
           <div class="distributed fr">
                <a href="javascript:void(0);" onclick="javascript:window.open('/baobiao/《CG绘画培训》课程掌握程度.xlsx')">导出数据</a>
            </div>
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《CG绘画培训》掌握程度</caption>
                <thead>
                <th>姓名</th>
                <th>已掌握程度</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》掌握程度" numberSuffix=" 个"  ><set value="3" label="90%" color="AFD8F8" /><set value="5" label="80%" color="F6BD0F" /><set value="3" label="70%" color="8BBA00" /><set value="2" label="60%" color="AFD8F8" /><set value="2" label="50%" color="F6BD0F" /><set value="1" label="40%" color="8BBA00" /></chart>';
