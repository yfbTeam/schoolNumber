<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledge_line_14.aspx.cs" Inherits="SMSWeb.analysisa.knowledge_line_1_4" %>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <div class="distributed fr">
                <a href="javascript:void(0);" onclick="javascript:window.open('/baobiao/《初一英语上册（人教版）》课程掌握程度.xlsx')">导出数据</a>
            </div>
            <table>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《初一英语上册（人教版）》掌握程度" numberSuffix=" 个"  ><set value="3" label="90%" color="AFD8F8" /><set value="5" label="80%" color="F6BD0F" /><set value="3" label="70%" color="8BBA00" /><set value="2" label="60%" color="AFD8F8" /><set value="2" label="50%" color="F6BD0F" /><set value="1" label="40%" color="8BBA00" /></chart>';
