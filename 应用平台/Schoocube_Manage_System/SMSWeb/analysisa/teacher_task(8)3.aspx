<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacher_task(8)3.aspx.cs" Inherits="SMSWeb.analysisa.teacher_task_8_3" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 文学修养（人教版）》课程完成情况</caption>
                <thead>
                    <th>课时总数</th>
                    <th>已完成课时数</th>
                    <th>未完成课时数</th>
...
<script>
    function initChart() {
        var xml = '<chart caption="《 文学修养（人教版）》课程完成情况" numberSuffix="%" ><set value="40" label="已完成" color="AFD8F8" /><set value="10" label="未完成" color="F6BD0F" /></chart>';
