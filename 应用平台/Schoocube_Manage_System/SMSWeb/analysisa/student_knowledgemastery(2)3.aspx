<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_knowledgemastery(2)3.aspx.cs" Inherits="SMSWeb.analysisa.student_knowledgemastery_2_3" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <script>
                ...
                function initChart() {
                    var xml = '<chart caption="《 MySQL入门》掌握程度" numberSuffix=" 个"  ><set value="2" label="100%" color="AFD8F8" /><set value="3" label="90%-99%" color="F6BD0F" /><set value="3" label="80%-89%" color="8BBA00" /><set value="5" label="70%-79%" color="AFD8F8" /></chart>';
