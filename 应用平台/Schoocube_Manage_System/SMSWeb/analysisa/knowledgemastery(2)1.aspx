<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledgemastery(2)1.aspx.cs" Inherits="SMSWeb.analysisa.knowledgemastery_2_1" %>
        ...
        <div class="width repository_header clearfix">
            ...
            <nav id="teacher" class="navbar menu_mid fl">
                <ul id="CourceMenu">
                    ...
                    <li currentclass="active" class="active"><a href="knowledgemastery(2).aspx">章节掌握程度</a></li>
                    ...
                    <li currentclass="active"><a href="student_feedback.aspx" class="on">学生反馈</a></li>
                </ul>
            </nav>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        <div class="stytem_select clearfix">
            ...
            <div class="stytem_select_right fr">
                <a href="knowledgemastery(2).aspx">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《python基础》掌握程度</caption>
                <thead>
                <th>姓名</th>
                <th>已掌握程度</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《python基础》掌握程度" numberSuffix=" 个"  ><set value="3" label="90%" color="AFD8F8" /><set value="5" label="80%" color="F6BD0F" /><set value="3" label="70%" color="8BBA00" /><set value="2" label="60%" color="AFD8F8" /><set value="2" label="50%" color="F6BD0F" /><set value="1" label="40%" color="8BBA00" /></chart>';
