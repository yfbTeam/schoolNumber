<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_knowledgemastery(2)1.aspx.cs" Inherits="SMSWeb.analysisa.student_knowledgemastery_2_1" %>
    ...
    <form id="form1" runat="server">
        <div>
                ...
                <div class="bordshadrad" style="background: #fff; padding: 20px;">
                    <div class="stytem_select clearfix">
                        ...
                        <div class="stytem_select_right fr">
                            <a href="student_knowledgemastery(2).aspx">
            ...
            <script>
                ...
                function initChart() {
                    var xml = '<chart caption="《 python基础》掌握程度" numberSuffix=" 个"  ><set value="2" label="100%" color="AFD8F8" /><set value="3" label="90%-99%" color="F6BD0F" /><set value="3" label="80%-89%" color="8BBA00" /><set value="5" label="70%-79%" color="AFD8F8" /></chart>';
