<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="common_question3.aspx.cs" Inherits="SMSWeb.analysisa.common_question3" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table id="table">
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《文学修养（人教版）》常见问题</caption>
                <tbody>
                   <tr>
