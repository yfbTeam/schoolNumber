<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work_correction_12.aspx.cs" Inherits="SMSWeb.analysisa.work_correction_12_" %>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="work_correction(12)1.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="work_correction(12)2.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="work_correction(12)3.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="work_correction(12)4.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="work_correction(12)5.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
