<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledge_line_12.aspx.cs" Inherits="SMSWeb.analysisa.knowledge_line_1_2" %>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <div class="distributed fr">
                <a href="javascript:void(0);" onclick="javascript:window.open('/baobiao/《MySQL入门》课程掌握程度.xlsx')">导出数据</a>
            </div>
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《MySQL入门》掌握程度</caption>
                <thead>
                <th>姓名</th>
                <th>已掌握程度</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《MySQL入门》掌握程度" numberSuffix=" 个"  ><set value="3" label="90%" color="AFD8F8" /><set value="5" label="80%" color="F6BD0F" /><set value="3" label="70%" color="8BBA00" /><set value="2" label="60%" color="AFD8F8" /><set value="2" label="50%" color="F6BD0F" /><set value="1" label="40%" color="8BBA00" /></chart>';
