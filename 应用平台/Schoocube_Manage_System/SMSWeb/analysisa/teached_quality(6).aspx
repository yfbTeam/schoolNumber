<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teached_quality(6).aspx.cs" Inherits="SMSWeb.analysisa.teached_quality_6_" %>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="teached_quality(6)1.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="teached_quality(6)2.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="teached_quality(6)3.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="teached_quality(6)4.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="teached_quality(6)5.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
