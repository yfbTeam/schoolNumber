<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="knowledgemastery(2).aspx.cs" Inherits="SMSWeb.analysisa.knowledgemastery_2_" %>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="knowledgemastery(2)1.aspx"><i class="icon icon-eye-open"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>MySQL入门
                                    ...
                                    <td>
                                        <a href="knowledgemastery(2)2.aspx"><i class="icon icon-eye-open"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>文学修养（人教版）
                                    ...
                                    <td>
                                        <a href="knowledgemastery(2)3.aspx"><i class="icon icon-eye-open"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="knowledgemastery(2)4.aspx"><i class="icon icon-eye-open"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>CG绘画培训
                                    ...
                                    <td>
                                        <a href="knowledgemastery(2)5.aspx"><i class="icon icon-eye-open"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
