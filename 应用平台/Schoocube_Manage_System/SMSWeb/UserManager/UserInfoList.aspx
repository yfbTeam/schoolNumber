<%@ Page Title="" Language="C#" MasterPageFile="~/SMS.Master" AutoEventWireup="true" CodeBehind="UserInfoList.aspx.cs" Inherits="SMSWeb.UserManager.UserInfoList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnEnter").click(function () {
                ...
                OL_ShowLayer(2, "新建用户", 480, 450, "AddUser.aspx", function (returnVal) {
                    if(returnVal=="1")
                    {
    ...
    <div class="Mp_content">
        <div class="td" id="first">
            <div class="searchtit">
                ...
                <asp:DropDownList ID="ddl_shenfen" CssClass="searinput" runat="server">
                    <asp:ListItem Value="0">请选择身份</asp:ListItem>
