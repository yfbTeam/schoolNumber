...
<body>
    ...
    <header class="repository_header_wrap manage_header">
        <div class="width repository_header clearfix">
            ...
            <nav class="navbar menu_mid fl">
                <ul>
                    <li class="active"><a  href="#" onclick="ChangeSrc('http://192.168.1.101:8072/InterfaceUser.aspx',this,'passport')">班级论坛</a></li>
                    ...
                    <li><a href="#" onclick="ChangeSrc('/SysMessage/EmailtemList.aspx?Type=0',this)">班级邮件</a></li>
                    <li><a href="#" onclick="ChangeSrc('/Library.aspx',this)">知识库</a></li>
                    <li><a href="#" onclick="ChangeSrc('/Exam/test.aspx',this)">考试管理</a></li>
                    <li><a href="#" onclick="ChangeSrc('/SysMessage/SmsItemList.aspx',this)">短信管理</a></li>
                    <li><a href="#" onclick="ChangeSrc('/SysMessage/WebMessage.aspx',this)">站内信</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="myexam bordshadrad width" style="padding:0px;">
            ...
            <div class="mycourse">
                <iframe src="http://192.168.1.101:9010/index.aspx" width="100%" height="1200px" id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no" ></iframe>
            </div>
        </div>
    </div>
    <!--预览试卷-->
