<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyExam.aspx.cs" Inherits="SMSWeb.OnlineLearning.MyExam" %>
...
<script type="text/javascript">
            ...
            $.each(json.result.retData.PagedData, function () {
                ...
                if (str == "学生") {
                    if (this.Statushow == "未阅" && this.typeid != 4) {
                        ...
                        if (this.typeid == 4) {
                            html += "<h2 style=\"width:200px\"><a href='window.open('/Exam/QuestionnaireSurvey .aspx?id=" + this.ID + "');' title=\"" + this.Title + "(可答)\">" + this.Title + "(可答)</a></h2>";
                        }
                        html += "<h2 style=\"width:200px\"><a href=\" /Exam/onlineanswer.aspx?id=" + this.ID + "\"title=\"" + this.epname + "(可答)\">" + this.epname + "(可答)</a></h2>";
                    } else {
                        html += "<h2 style=\"width:200px\"><a href='javacript:void(0);' style=\"color:gray;\" onclick=\"return confirm('不再规定时间内，无法答题')\" title=\"" + this.epname + "(不可答)\">" + this.epname + "(不可答)</a></h2>";
                    }
                } else {
                    if (this.Statushow == "未阅" && this.typeid != 4) {
                        html += "<h2 style=\"width:200px\"><a href='#' onclick=\"AnsweredExam(" + this.ID + ",this)\" id='" + this.CreateUID + "'>" + this.Title + "</a></h2>";
                        ...
                        html += "<h2 style=\"width:200px\"><a href='javacript:void(0);' style=\"color:gray;\" >" + this.Title + "</a></h2>";
                    }
                }
    ...
    function AnsweredExam(idd, em) {
        ...
        window.open('/Exam/AnsweredExam.aspx?id=' + idd + '&name=' + em.id);
        //window.location.href = 'AnsweredExam.aspx?id=' + ID + '&name=' + em.id;
    }
    //function onlineanswer(josn,name) {
    //    var userid = $("#hIDCard").val();
    //    var name = $("#hName").val();
    //    var id = 0;
    ...
    //                    window.open(" /Exam/onlineanswer.aspx?id=" + josn);
