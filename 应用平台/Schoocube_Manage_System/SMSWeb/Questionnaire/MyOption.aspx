<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOption.aspx.cs" Inherits="SMSWeb.Questionnaire.MyOption" %>
            ...
            <div class="myexam bordshadrad">
                <div class="stytem_select clearfix">
                    ...
                    <div id="student1" class="stytem_select_left fl">
                        <a href="javascript:;" onclick="onquery(1)">问卷调查</a>
                    </div>
            ...
            if (this.ID == josn) {
                $.ajax({
                    ...
                    success: function (data) {
                        window.open("Onlineanswer.aspx?id=" + josn);// Onlineanswer
