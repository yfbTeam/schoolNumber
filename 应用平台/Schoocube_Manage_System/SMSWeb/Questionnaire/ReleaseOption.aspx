<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseOption.aspx.cs" Inherits="SMSWeb.Questionnaire.ReleaseOption" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="newtest_detail">
                <div class="newtest_title clearfix">
					<p class="newtest_name"><span>问卷名称：</span><span id="content"></span></p>
					<div class="newtest_starttime fl clearfix">
						<label for="">问卷有效开始时间：</label>
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (json.result.retData != "") {
                        alert('发布成功');
                        parent.location.href = "Option.aspx?ParentID=19";
                    }
                }
            });
        }
