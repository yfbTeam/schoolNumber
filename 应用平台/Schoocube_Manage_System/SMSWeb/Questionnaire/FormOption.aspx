<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormOption.aspx.cs" Inherits="SMSWeb.Questionnaire.FormOption" %>
                ...
                <div class="width repository_header clearfix">
                    ...
                    <nav class="navbar menu_mid fl">
                        <ul>  
                            ...
                            <li class="active"><a href="/Questionnaire/FormOption.aspx">问卷管理</a></li>
                ...
                <div style="background:#fff;padding:0px 20px;" class="bordshadrad">
                    ...
                    <div class="stytem_select clearfix">
                        <div class="stytem_select_left fl">
                            <a href="javascript:;" class="on" onclick="ChangeRelease(1);">已发布问卷调查</a>
                            <a href="javascript:;" onclick="ChangeRelease(2);">未发布问卷调查</a>
                        </div>
                        <div class="stytem_select_right fr">
                            ...
                            <a href="javascript:;" class="newtest" onclick="MakeExamPaper()">
                                <i class="icon icon-plus"></i>新建问卷调查
...
<script type="text/javascript">
        ...
        if (json.result.errNum.toString() == "0") {
            ...
            $.each(json.result.retData.PagedData, function () {
                ...
                + "</div><div class=\"test_description exam_description fl\">"
								+ "<h2><a href='#' onclick=\"LookQuestion("+this.ID+",1,4)\">" + this.Title + "</a></h2>"
    ...
    function LookQuestion(Id, Template, Qtype) {
        OpenIFrameWindow('预览问卷调查', 'LookQuestion.aspx?Id=' + Id + "&type=" + Qtype, '780px', '70%');
        //OpenIFrameWindow('预览试卷', 'ExamPaperDetail.aspx?id=' + id, '900px', '70%');
    }
    function ChangPaperStatus(Id, qtype, em) {
        OpenIFrameWindow('发布试卷', 'ReleaseOption.aspx?Id=' + Id + '&name=' + em.id + '&qtype=' + qtype, '780px', '70%');
    }
