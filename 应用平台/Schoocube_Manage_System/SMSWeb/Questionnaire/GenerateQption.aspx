<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerateQption.aspx.cs" Inherits="SMSWeb.Questionnaire.GenerateQption" %>
                ...
                <img src="/images/logo.png" /></a>
                    ...
                    <nav class="navbar menu_mid fl">
                        <ul>
                            ...
                            <li currentclass="active" class="active"><a href="/Questionnaire/FormOption.aspx">问卷管理</a></li>
                ...
                <div class="stytem_items">
                    <div class="stytem_item clearfix a">
                        ...
                        <div class="stytem_items_list fl" id="QuestionsID">
                            ...
                            <a href="javascript:;" id='sh' class="on" onclick=' PeriodChangealls(1,this)' value="生活类">生活类</a>
                ...
                <div class="bordshadrad" style="background: #fff;padding:20px;">
                    ...
                    <div class="stytem_select clearfix">
                        ...
                        <div class="stytem_select_right fr">
                            <a href="FormOption.aspx?ParentID=19">
					...
					<h1 class="testassem_btn">
						<div>
							...
							<a href="javascript:;" id="ADDExamExamination" class="back_testassem" onclick="ADDExamExamination()" style="background-color:#1472b9;">确认组卷</a>
						</div>
					</h1>
                    </div>
...
<script type="text/javascript">
    ...
    function MakeExamPaper() {
        ...
        location.href = "FormOptionEdit.aspx" + parm;
    }
                    ...
                    if (jk == 1) {
                        $.ajax({
                            ...
                            data: {
                                PageName: "/Exam/ExamHandler.ashx",
                                "action": "addexamlist",
                                "Title": ExaminationName, "ExamTime": ExaminationTime, "Difficulty": diffice, "Status": Static, "Type": examtype, "FullScore": zongfen, "Klpoint": "0", "Book": "", "IsRelease": IsRelease, "CreateTime": CreateTime, "Author": Author,
                            },
                            success: function (json) {
