                    ...
                    <div class="testassem">
                        ...
                        <h1 class="testassem_btn">
                            <div>
                                ...
                                <a id="ADDExamExamination" class="ml10" style="background:#1472b9" onclick="ADDExamExamination()">确认组卷</a>
                            </div>
                        </h1>
                    </div>
                            ...
                            if (jk == 1) {
                                $.ajax({
                                    ...
                                    data: {
                                        PageName: "/Exam/ExamHandler.ashx",
                                        "action": "addexamlist",
                                        "Title": ExaminationName, "ExamTime": ExaminationTime, "Difficulty": diffice, "Status": Static, "Type": examtype, "FullScore": zongfen, "Klpoint": Klpoint, "Book": Book, "IsRelease": IsRelease, "Author": Author,
                                    },
                                    success: function (json) {
