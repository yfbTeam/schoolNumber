<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="onlineanswermobile.aspx.cs" Inherits="SMSWeb.Exam.onlineanswermobile" %>
                    ...
                    if (json.result.errNum.toString() == "0") {
                        $.each(json.result.retData, function () {
                            ...
                            htmll += "<div class=\"paper_mes\">"
                                + "<div class=\"paper_numer\">"
                                    + "<h1 class=\"clearfix\">"
                                        + "<div class=\"paper_number_name fl\">大题、<span>"
                                        + this.Title + "</span>（本大题共" + this.sum + "小题，共" + this.score + "分）"
                                        + "</div>"
                                        + "<div class=\"paper_more fr\">"
                                            + "<i class=\"icon icon-angle-up active\"></i>"
                    ...
                    $.each(json.result.retData, function () {
                        ...
                        if (this.QType == 2) {
                            if (this.Template == 1) {
                                ...
                                if (this.OptionA != "") { fhr += "<p><input id=\"rdoOpA\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"A\" />A：" + this.OptionA + "</p>"; }
                                if (this.OptionB != "") { fhr += "<p><input id=\"rdoOpB\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"B\" />B：" + this.OptionB + "</p>"; }
                                if (this.OptionC != "") { fhr += "<p><input id=\"rdoOpC\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"C\" />C：" + this.OptionC + "</p>"; }
                                if (this.OptionD != "") { fhr += "<p><input id=\"rdoOpD\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"D\" />D：" + this.OptionD + "</p>"; }
                                if (this.OptionE != "") { fhr += "<p><input id=\"rdoOpE\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"E\" />E：" + this.OptionE + "</p>"; }
                                if (this.OptionF != "") { fhr += "<p><input id=\"rdoOpF\" name=\"panswer\" type=\"radio\" onclick=\"obtains(" + this + ")\" value=\"F\" />F：" + this.OptionF + "</p>"; }
                                fhr += "</div>";
