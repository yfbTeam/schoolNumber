...
<script type="text/javascript">
            ...
            $.each(json.result.retData.PagedData, function () {
                ...
                if (str == "学生") {
                    if (this.Statushow == "未阅" && this.typeid != 4) {
                        ...
                        html += "<h2 style=\"width:200px\"><a href='window.open('/Exam/onlineanswer.aspx?id=" + this.ID + + "');''>" + this.epname + "(可答)</a></h2>";
                    } else {
    ...
    function AnsweredExam(idd, em) {
        ...
        //OpenIFrameWindow('查看试卷', '/Exam/AnsweredExam.aspx?id=' + ID + '&name=' + em.id, '800px', '80%');
    ...
    //                    //OpenIFrameWindow('答卷', '/Exam/onlineanswer.aspx?id=' + ID + '&name=' + name, '780px', '70%');
    //                }
    //            });
    //        }
    //    });
