        ...
        <div>
            ...
            <div class="dialog_detail">
                ...
                <div class="row clearfix mt10 checkbox none">
                    ...
                    <p class="clearfix">
                        <input id="cbOptionA" name="danswer" type="checkbox" onclick="duoicochange(this);" value="A" /><input id="ckOptionA" type="text" name="OptionA" placeholder="请输入A选项内容" class="txt" />
                        <div class="upload_imga">
                    ...
                    <p class="clearfix">
                        <input id="cbOptionB" name="danswer" type="checkbox" onclick="duoicochange(this);" value="B" /><input id="ckOptionB" type="text" name="OptionB" placeholder="请输入B选项内容" class="txt" />
                        <div class="upload_imga">
                    ...
                    <p class="clearfix">
                        <input id="cbOptionC" name="danswer" type="checkbox" onclick="duoicochange(this);" value="C" /><input id="ckOptionC" type="text" name="OptionC" placeholder="请输入C选项内容" class="txt" />
                        <div class="upload_imga">
                    ...
                    <p class="clearfix">
                        <input id="cbOptionD" name="danswer" type="checkbox" onclick="duoicochange(this);" value="D" /><input id="ckOptionD" type="text" name="OptionD" placeholder="请输入D选项内容" class="txt" />
                        <div class="upload_imga">
                    ...
                    <p class="clearfix">
                        <input id="cbOptionE" name="danswer" type="checkbox" onclick="duoicochange(this);" value="E" /><input id="ckOptionE" type="text" name="OptionE" placeholder="请输入E选项内容" class="txt" />
                        <div class="upload_imga">
                    ...
                    <p class="row clearfix">
                        <input id="cbOptionF" name="danswer" type="checkbox" onclick="duoicochange(this);" value="F" /><input id="ckOptionF" type="text" name="OptionF" placeholder="请输入F选项内容" class="txt" />
                        <div class="upload_imga">
...
<script type="text/javascript">
    ...
    var Analysiseditor;
    var Questioneditor;
    var Answereditor;//.html(Data[0].Answer);
