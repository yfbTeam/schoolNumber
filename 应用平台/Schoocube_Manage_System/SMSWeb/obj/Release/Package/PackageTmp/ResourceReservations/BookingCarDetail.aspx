    ...
    <script type="text/javascript">
        ...
        $('.stytem_select_left a').click(function () {
            ...
            if (name == "会议室") {
                ...
                url = "BookingCar.aspx?Type=1&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName+"&ResourceTypeName=" + name;
            } else if (name == "专业教室") {
                $("#carreservation").text("专业教室预约");
                $("#carreservation").addClass('on').siblings().removeClass('on');
                 url = "BookingCar.aspx?Type=2&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName+"&ResourceTypeName=" + name;
            } else {
                $("#carreservation").text("车辆预约");
                $("#carreservation").addClass('on').siblings().removeClass('on');
                 url = "BookingCar.aspx?Type=0&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName+"&ResourceTypeName=" + name;
            }
        ...
        $(".stytem_select_right").bind("click", function () {
            ...
            var gobackUrl = "";
            if (name == "会议室") {
                gobackUrl = "BookingCar.aspx?Type=1&TypeName=" + escape($("#approvalreservation").text()) + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + name;
                
            } else if (name == "专业教室") {
                $("#carreservation").text("专业教室预约");
                $("#carreservation").addClass('on').siblings().removeClass('on');
                gobackUrl = "BookingCar.aspx?Type=2&TypeName=" + escape($("#approvalreservation").text())+"&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + name;
            } else {
                $("#carreservation").text("车辆预约");
                $("#carreservation").addClass('on').siblings().removeClass('on');
                gobackUrl = "BookingCar.aspx?Type=0&TypeName=" + escape($("#approvalreservation").text())+"&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + name;
            }
        ...
        function approvalClick() {
            ...
            //var name = unescape(UrlDate.ResourceTypeName);
            var url = "BookingCar.aspx?Type=3&TypeName=" + escape($("#approvalreservation").text()) + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + name;
            $("#approvalreservation").attr("href", url);
        }
        ...
        function myapprovalClick() {
            ...
            //var name = unescape(decodeURI(UrlDate.ResourceTypeName));
            //var name = unescape(UrlDate.ResourceTypeName);
            var url = "BookingCar.aspx?Type=4&TypeName=" + escape($("#myapprovalreservation").text()) + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + name;
        ...
        function setTabClass() {
            ...
            if (name == "会议室") {
                ...
                $("#carreservation").text("会议室预约");
                Url = "BookingCar.aspx?Type=1&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + UrlDate.ResourceTypeName;
            } else if (name == "专业教室") {
                $(".stytem_select_left a[id=proroom]").addClass('on').siblings().removeClass('on');
                $("#carreservation").text("专业教室预约");
                Url = "BookingCar.aspx?Type=2&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + UrlDate.ResourceTypeName;
            } else {
                $(".stytem_select_left a[id=car]").addClass('on').siblings().removeClass('on');
                $("#carreservation").text("车辆预约");
                Url = "BookingCar.aspx?Type=0&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName + "&ResourceTypeName=" + UrlDate.ResourceTypeName;
            }
