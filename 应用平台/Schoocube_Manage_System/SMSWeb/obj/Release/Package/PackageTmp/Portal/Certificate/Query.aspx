...
<head runat="server">
    ...
    <script id="tr_data" type="text/x-jquery-tmpl">
        <li><a href=""><img src="${Attachment}" /><p>${cName}</p></a></li>
    </script>
...
<body>
            ...
            <div class="content fr">
                ...
                <div class="content_detail" style="padding: 10px 0px;">
                    <div class="search_wrap">
                        <input type="text" placeholder=""  id="StuNo"/> <input type="button" id="queryCertificate" value="搜索 " />
                    </div>
                    <div>
    ...
    <script type="text/javascript">
            ...
            if ($.cookie('LoginCookie_Cube') == null || $.cookie('LoginCookie_Cube') == "null" || $.cookie('LoginCookie_Cube') =="") {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        if (json.CertificateManage!=null) {
                            if (json.CertificateManage.errMsg == "success") {
                                $("#tb_data").html('');
                                if (json.CertificateManage.retData != null) {
                                    $("#tr_data").tmpl(json.CertificateManage.retData.PagedData).appendTo("#tb_data");
                                    makePageBar(getData, document.getElementById("pageBar"), json.CertificateManage.retData.PageIndex, json.CertificateManage.retData.PageCount, 10, json.CertificateManage.retData.RowCount);
                                } else {
        ...
        function Query()
        {
            if ($("#StuNo").val() == "" || $("#StuNo").val().length == 0) return;
            $.ajax({
                url: "/Common.ashx",
                type: "post",
                async: false,
