<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolStyleEdit.aspx.cs" Inherits="SMSWeb.Portal.SchoolStyle.SchoolStyleEdit" %>
                ...
                <div class="clearfix">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="course_form_div clearfix">
                            ...
                            <div id="uploader" class="wu-example none">
                                <div class="queueList">
                                ...
                                <div class="statusBar" style="display: none;">
                                    ...
                                    <div class="btns">
                                        <div id="filePicker2" class="webuploader-container">
                                            <div class="webuploader-pick none">继续添加</div>
        ...
        $(function () {
            ...
            $("#btnDelShowImg").click(function () {
                $.ajax({
                    ...
                    async: false,
                    dataType: "json",
                    data: { PageName: "PortalManage/SchoolStyle.ashx", Func: "UpdateSchoolStyle", Id: $("#SchoolId").val(), ShowImgUrl: "" },
