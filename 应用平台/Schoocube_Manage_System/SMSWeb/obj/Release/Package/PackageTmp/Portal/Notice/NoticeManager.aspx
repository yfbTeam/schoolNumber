    ...
    <script id="tr_notice" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>
                ...
                <a href="javascript:;" onclick="DeleteNotice('${Id}')"><i class="icon icon-road"></i>删除</a>
            </td>
        </tr>
    </script>
            ...
            <div class="course_manage bordshadrad">
                ...
                <div class="newcourse_select clearfix">
                    ...
                    <div class="distributed fr">
                        <a href="javascript:void(0);" onclick="queryTab('q')"><i class="icon icon-plus"></i>查询</a>
                        <a href="javascript:void(0);" onclick="queryTab('key')"><i class="icon icon-plus"></i>全文检索</a>
        ...
        function keyWordquery(startIndex, pageSize)
        {
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errMsg == "success") {
                        $("#bindData").html('');
                        $("#tr_keyword").tmpl(json.result.retData.PagedData).appendTo("#bindData");
