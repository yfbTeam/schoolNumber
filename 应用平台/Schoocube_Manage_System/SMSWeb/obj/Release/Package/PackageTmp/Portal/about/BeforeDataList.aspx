<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeforeDataList.aspx.cs" Inherits="SMSWeb.Portal.about.BeforeDataList" %>
...
<head runat="server">
    ...
    <script type="text/x-jquery-tmpl" id="tr_data">
        <li class="clearfix">
            <div class="l-s fl">
                <a href="BeforeView.aspx?ssId=${Id}&id=${MenuId}">
                    <img src="${ImageUrl}" alt="" width="238" height="175"></a>
            </div>
            <div class="r-s fl" style="height:175px;overflow:hidden;">
                <h3 class="n"><a href="BeforeView.aspx?ssId=${Id}&id=${MenuId}">${Title}</a></h3>
