    ...
    <div class="footer">
        <div class="footer_con width">
            <div class="foot_left fl" id="footerAdmin">
                ...
                <p>电子邮件（E-MAIL）:yqybjxzb@sohu.com  网站设计/技术支持：圣邦天麒 <span style="margin-left: 20px;">网站在线人数：<i><asp:Label ID="PersonCount" runat="server" Text="0"></asp:Label></i></span></p>
            </div>
    ...
    <script type="text/javascript">
        $(function () {
            if ($.cookie('LoginCookie_Cube') != null && $.cookie('LoginCookie_Cube') != "null" && $.cookie('LoginCookie_Cube') != "") {
                ...
                //                $("#footerAdmin").append("<p><a target=\"_blank\"  href='javascript:ResponstUrl();'>管理员后台登录</a></p>");
                //            }
                //        }
                //    }
