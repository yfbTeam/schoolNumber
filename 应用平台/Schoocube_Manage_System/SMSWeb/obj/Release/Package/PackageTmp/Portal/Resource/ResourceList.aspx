    ...
    <script type="text/x-jquery-tmpl" id="tr_datagg">
        <li class="clearfix">
            <div class="docu_messages fl">
                <p class="docu_title"><span class="h-ico h-ico-word"></span><a class="docu_name" href="javascript:downFile('${FileUrl}');">${Name}</a></p>
            </div>
...
<body>
    <form id="form1" runat="server">
       ...
       <%--div id="htmlHeader" style="min-height:155px;"></div>--%>
        ...
        <!--footer-->
        <iframe name="htmlFoot" src="../bottom.aspx" scrolling="no" allowtransparency="true" frameborder="no" width="100%"></iframe>
    </form>
