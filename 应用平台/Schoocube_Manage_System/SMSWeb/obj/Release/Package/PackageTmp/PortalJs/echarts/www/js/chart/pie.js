define("echarts/chart/pie", ["require", "./base", "zrender/shape/Text", "zrender/shape/Ring", "zrender/shape/Circle", "zrender/shape/Sector", "zrender/shape/Polyline", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/math", "zrender/tool/color", "../chart"],
function (e) {
    ...
    return t.prototype = {
        ...
        _buildShape: function () {
            ...
            for (var s, d = 0,
            c = e.length; c > d; d++) if (e[d].type === l.CHART_TYPE_PIE) {
        ...
        _buildSinglePie: function (e) {
            ...
            n = i[e], a = n.data, o = this.component.legend, r = 0, s = 0, l = 0, h = Number.NEGATIVE_INFINITY, d = [], c = 0, m = a.length; m > c; c++) t = a[c].name,
            this.selectedMap[t] = o ? o.isSelected(t) : !0,
            this.selectedMap[t] && !isNaN(a[c].value) && (0 !== +a[c].value ? r++ : s++, l += +a[c].value, h = Math.max(h, +a[c].value));
            if (0 !== l) {
                for (var p, u, g, V, U, y, f = 100,
                _ = n.clockWise,
                b = (n.startAngle.toFixed(2) - 0 + 360) % 360, x = n.minAngle || .01, k = 360 - x * r - .01 * s, v = n.roseType, c = 0, m = a.length; m > c; c++) if (t = a[c].name, this.selectedMap[t] && !isNaN(a[c].value)) {
                ...
                for (var c = 0,
                m = d.length; m > c; c++) this.shapeList.push(d[c]);
                d = null
            }
        },
        ...
        getLabel: function (e, t, i, a, o, r, s) {
            ...
            if (this._needLabel(h, m, s)) {
                var p, u, g, V = s ? "emphasis" : "normal",
                U = d.merge(d.clone(m.itemStyle) || {},
                h.itemStyle),
                y = U[V].label,
                f = y.textStyle || {},
                _ = a[0],
        ...
        _layoutCalculate: function (e, t, i, n) {
            ...
            function r(e, t, i, n, a) {
                for (var o, r, s, l = i[0], h = i[1], d = a > 0 ? t ? Number.MAX_VALUE : 0 : t ? Number.MAX_VALUE : 0, c = 0, m = e.length; m > c; c++) r = Math.abs(e[c]._rect.y - h),
                s = e[c]._radius - n,
                ...
                e[c]._labelLine && (e[c]._labelLine.style.pointList[2][0] = l + (o - 5) * a, e[c]._labelLine.style.pointList[1][0] = l + (o - 20) * a),
                d = o
            }
            e.sort(function (e, t) {
        ...
        reformOption: function (e) {
            var t = d.merge;
            return e = t(t(e || {},
            d.clone(this.ecTheme.pie || {})), d.clone(l.pie)),
        ...
        addDataAnimation: function (e, t) {
            ...
            for (var p, u, g, V = {},
            o = 0,
            r = e.length; r > o; o++) p = e[o][0],
            u = e[o][2],
            g = e[o][3],
            n[p] && n[p].type === l.CHART_TYPE_PIE && (u ? (g || (h[p + "_" + n[p].data.length] = "delete"), V[p] = 1) : g ? V[p] = 0 : (h[p + "_-1"] = "delete", V[p] = -1), this._buildSinglePie(p));
            for (var U, y, o = 0,
            r = this.shapeList.length; r > o; o++) switch (p = this.shapeList[o]._seriesIndex, U = this.shapeList[o]._dataIndex, y = p + "_" + U, this.shapeList[o].type) {
                case "sector":
            ...
            this.shapeList = [];
            for (var f, o = 0,
            r = m.length; r > o; o++) if (p = m[o]._seriesIndex, a[p]) {
                ...
                else if ("text" === m[o].type || "polyline" === m[o].type) if ("delete" === f) this.zr.delShape(m[o].id);
                else switch (m[o].type) {
                    case "text":
                        s++,
                        f = d[y],
        ...
        onclick: function (e) {
            ...
            if (this.isClick && e.target) {
                ...
                a = n.style,
                o = h.get(n, "seriesIndex"), r = h.get(n, "dataIndex"), s = 0, d = this.shapeList.length; d > s; s++) if (this.shapeList[s].id === n.id) {
                    if (o = h.get(n, "seriesIndex"), r = h.get(n, "dataIndex"), a._hasSelected) n.style.x = n.style._x,
