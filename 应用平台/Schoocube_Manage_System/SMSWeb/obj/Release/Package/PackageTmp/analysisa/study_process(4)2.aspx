<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="study_process(4)2.aspx.cs" Inherits="SMSWeb.analysisa.study_process_4_2" %>
...
<body>
    ...
    <div class="onlinetest_item width pt90 pr ">
        <div class="bordshadrad" style="background: #fff;padding:20px;">
            ...
            <div class="wrap">
                <table>
                    <caption style="line-height: 40px;text-align:center;font-weight: bold;">《MySQL入门》学习进度</caption>
                    <thead>
                    <th>姓名</th>
                    <th>完成进度</th>
                    </thead>
    ...
    <script>
        ...
        function initChart() {
            var xml = '<chart caption="《MySQL入门》学习进度" numberPrefix="个" ><set value="1" label="100%" color="AFD8F8" /><set value="3" label="90%-99%" color="F6BD0F" /><set value="7" label="80%-89%" color="8BBA00" /><set value="2" label="70%-79%" color="AFD8F8" /><set value="2" label="60%-69%" color="F6BD0F" /><set value="1" label="60%以下" color="8BBA00" /></chart>';
