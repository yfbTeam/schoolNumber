<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_feedback(14)4.aspx.cs" Inherits="SMSWeb.analysisa.student_feedback_14_4" %>
        ...
        <div class="width repository_header clearfix">
            ...
            <nav id="teacher" class="navbar menu_mid fl">
                <ul id="CourceMenu">
                    ...
                    <li currentclass="active" class="active"><a href="student_feedback(14).aspx" class="on">学生反馈</a></li>
                </ul>
            </nav>
    ...
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        <div class="stytem_select clearfix">
            ...
            <div class="stytem_select_right fr">
                <a href="student_feedback(14).aspx">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《初一英语上册（人教版）》学生反馈情况</caption>
                <thead>
                <th>姓名</th>
                <th>对老师评价</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《初一英语上册（人教版）》学生反馈情况" numberPrefix=" 人"  ><set value="5" label="非常棒" color="AFD8F8" /><set value="8" label="很好" color="F6BD0F" /><set value="2" label="一般" color="8BBA00" /><set value="1" label="差" color="AFD858"/></chart>';
