<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_correction(9).aspx.cs" Inherits="SMSWeb.analysisa.test_correction_9_" %>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="test_correction(9)1.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_correction(9)2.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_correction(9)3.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="test_correction(9)4.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_correction(9)5.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
