<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Knowledge_track.aspx.cs" Inherits="SMSWeb.analysisa.Knowledge_track" %>
        ...
        <div class="bordshadrad" style="background: #fff;padding:20px;">
            <div class="stytem_select clearfix">
                <div class="stytem_select_left fl">
                    <a href="student_studyprocess(4).html" >课时跟踪</a>
                    <a href="student_knowledgemastery(2).html">掌握程度</a>
                    <a href="Knowledge_track.html" class="on">知识点跟踪</a>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="Knowledge_track1.aspx"><i class="icon icon-eye-open"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="Knowledge_track2.aspx"><i class="icon icon-eye-open"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="Knowledge_track3.aspx"><i class="icon icon-eye-open"></i></a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Knowledge_track4.aspx"><i class="icon icon-eye-open"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="Knowledge_track5.aspx"><i class="icon icon-eye-open"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
