...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 CG绘画培训》作业完成情况</caption>
                <thead>
                    <th>姓名</th>
                    <th>总次数</th>
                    <th>完成次数</th>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》作业完成情况" numberPrefix=" 个"  ><set value="1" label="50次" color="AFD8F8" /><set value="3" label="45次-49次" color="F6BD0F" /><set value="7" label="40次-44次" color="F6AFDF" /><set value="2" label="35次-39次" color="F6FD8F" /><set value="2" label="30次-34次" color="FAFD8F" /><set value="1" label="30次以下" color="FAFD8F" /></chart>';
