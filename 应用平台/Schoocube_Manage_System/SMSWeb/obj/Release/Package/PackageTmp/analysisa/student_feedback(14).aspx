<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_feedback(14).aspx.cs" Inherits="SMSWeb.analysisa.student_feedback_14_" %>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="student_feedback(14)1.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="student_feedback(14)2.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="student_feedback(14)3.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="student_feedback(14)4.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="student_feedback(14)5.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
