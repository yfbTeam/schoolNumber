<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_feedback(14)3.aspx.cs" Inherits="SMSWeb.analysisa.student_feedback_14_3" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 文学修养（人教版）》学生反馈情况</caption>
                <thead>
                <th>姓名</th>
                <th>对老师评价</th>
                </thead>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《文学修养（人教版）》学生反馈情况" numberPrefix=" 人"  ><set value="5" label="非常棒" color="AFD8F8" /><set value="8" label="很好" color="F6BD0F" /><set value="2" label="一般" color="8BBA00" /><set value="1" label="差" color="AFD858"/></chart>';
