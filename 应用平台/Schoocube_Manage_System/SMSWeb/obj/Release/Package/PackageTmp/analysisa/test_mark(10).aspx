<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_mark(10).aspx.cs" Inherits="SMSWeb.analysisa.test_mark_10_" %>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="test_mark(10)1.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_mark(10)2.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_mark(10)3.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="test_mark(10)4.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a href="test_mark(10)5.aspx"><i class="icon icon-eye-open"></i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
