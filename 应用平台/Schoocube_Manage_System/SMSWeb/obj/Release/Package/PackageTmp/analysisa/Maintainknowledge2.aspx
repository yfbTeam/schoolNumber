<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Maintainknowledge2.aspx.cs" Inherits="SMSWeb.analysisa.Maintainknowledge2" %>
...
<body>
    ...
    <script>
        ...
        function initChart() {
            var xml = '<chart caption="《MySQL入门》知识点统计" numberPrefix=" 个"  ><set value="9" label="易掌握" color="AFD8F8" /><set value="4" label="不易掌握" color="F6BD0F" /></chart>';
