...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《python基础》教学质量评价" numberPrefix=" 人"  ><set value="5" label="非常棒" color="AFD8F8" /><set value="8" label="很好" color="F6BD0F" /><set value="2" label="一般" color="8BBA00" /><set value="1" label="差" color="AFD8F8"/></chart>';
