<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_studyprocess(4)5.aspx.cs" Inherits="SMSWeb.analysisa.student_studyprocess_4_5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《CG绘画培训》学习进度情况</caption>
                <thead>
                    <th>总课时</th>
                    <th>已完成课时数</th>
                    <th>未完成课时数</th>
    ...
    <script>
        function initChart() {
            var xml = '<chart caption="《CG绘画培训》学习进度情况" numberPrefix="课时"  ><set value="25" label="已完成" color="AFD8F8" /><set value="5" label="未完成" color="F6BD0F" /></chart>';
