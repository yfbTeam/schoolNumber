<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work_quality5.aspx.cs" Inherits="SMSWeb.analysisa.work_quality5" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《 CG绘画培训》作业整体质量</caption>
                <thead>
                <th>优</th>
                <th>良</th>
                <th>中</th>
...
<script>
    function initChart() {
        var xml = '<chart caption="《CG绘画培训》作业整体质量" numberPrefix=" 个"  ><set value="4" label="优" color="AFD8F8" /><set value="7" label="良" color="F6BD0F" /><set value="4" label="中" color="AFD8F8" /><set value="1" label="差" color="F6BD0F" /></chart>';
