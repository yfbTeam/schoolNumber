<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_correction(9)4.aspx.cs" Inherits="SMSWeb.analysisa.test_correction_9_4" %>
        ...
        <div class="width repository_header clearfix">
            ...
            <nav id="teacher" class="navbar menu_mid fl">
                <ul id="CourceMenu">
                    ...
                    <li currentclass="active" class="active"><a href="test_correction(9).aspx" class="on">试卷批改</a></li>
                </ul>
            </nav>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《初一英语上册（人教版）》试卷批改情况</caption>
                <thead>
                <th>试卷总张数</th>
                <th>及时批改张数</th>
                <th>未及时批改张数</th>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《初一英语上册（人教版）》试卷批改情况" numberPrefix=" 张"  ><set value="140" label="及时批改" color="AFD8F8" /><set value="10" label="未及时批改" color="F6BD0F" /></chart>';
