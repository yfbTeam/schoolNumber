<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_mark(10)1.aspx.cs" Inherits="SMSWeb.analysisa.test_mark_10_1" %>
...
<div class="onlinetest_item width pt90 pr ">
    <div  class="bordshadrad chartsdiv" style="background: #fff;padding:20px;">
        ...
        <div class="wrap">
            ...
            <table>
                <caption style="line-height: 40px;text-align:center;font-weight: bold;">《python基础》考试成绩</caption>
                <thead>
                    <tr>
                        <th>姓名</th>
                        <th>成绩</th>
...
<script>
    ...
    function initChart() {
        var xml = '<chart caption="《python基础》考试成绩" numberPrefix="人数" ><set value="1" label="100分" color="AFD8F8" /><set value="3" label="90-99" color="F6BD0F" /><set value="7" label="80-89" color="8BBA00" /><set value="2" label="70-79" color="AFD8F8" /><set value="2" label="60-69" color="F6BD0F" /><set value="1" label="60分以下" color="8BBA00" /></chart>';
