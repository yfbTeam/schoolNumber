<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="SMSWeb.Exam.test" %>
...
<script type="text/javascript">
    ...
    function ChangPaperStatus(Id, qtype, em) {
        OpenIFrameWindow('发布试卷', 'ReleaseExam.aspx?Id=' + Id + '&name=' + em.id + '&qtype=' + qtype, '780px', '70%');
    }
