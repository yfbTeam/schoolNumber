...
<head>
    ...
    <script type="text/javascript">
        ...
        function UpEmail(id) {
            OpenIFrameWindow('修改邮箱', 'EmailConrim.aspx?ID=' + id, '350px', '180px');
        }
        // 学生详细信息
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        $('#phone_wrap').html('<span style="color:black;" id="Phone"></span><a href="javascript::" style="color:red;margin-left:10px;">修改>></a>')
        ...
        function EditStu() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    Birthday: Birthday, fixPhone: fixPhone, Email: Email, Address: Address
                },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        layer.msg("修改成功");
...
<body>
            ...
            <div class="space_center fl">
                            ...
                            <form id="myform">
                                <table class="set-mold-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><a href="javascript:void(0)" class="xiugai" onclick="EditStu()">确认修改</a></td>
                                        </tr>
                ...
                <div class="space_centerwrap none">
                    <div class="messages_state">
                        <ul>
                            <li>
                                <span style="color: #ea5666">[未读消息]</span>
                                <a href="">你有10个考试未完成</a>
                                <span class="fr date">2016-08-26</span>
                            </li>
                            <li>
                                <span style="color: #ea5666">[未读消息]</span>
                                <a href="">你有10个考试未完成</a>
                            ...
                            <li>
                                <span style="color: #3bbb53">[已读消息]</span>
                                <a href="">你有10个考试未完成</a>
                                <span class="fr date">2016-08-26</span>
                            </li>
                            <li>
    ...
    <script type="text/javascript">
        ...
        function GetMessge() {
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        $("#NewMessage").html('');
                        $("#li_Message").tmpl(json.result.retData).appendTo("#NewMessage");
                    }
                    else {
                        $("#NewMessage").html("");
                    }
        ...
        //添加培训档案
        function AddTrain() {
            OpenIFrameWindow('添加培训档案', 'TrainingAdd.aspx', '600px', '370px');
        }
        ...
        function ExportTrain() {
            window.open('/PersonalSpace/ToExcelHandler.ashx', "myIframe");
        }
        //证书模板
        function bindModol() {
            $.ajax({
        ...
        function ShowCertificate(ID) {
            OpenIFrameWindow('证书预览', 'CertificateShow.aspx?ID=' + ID + "&Type=2", '480px', '460px');
        }
        function UpdatePwd() {
