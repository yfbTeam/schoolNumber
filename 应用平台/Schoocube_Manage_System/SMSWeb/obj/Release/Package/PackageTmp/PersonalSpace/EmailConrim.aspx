    ...
    <script type="text/javascript">
        ...
        function sendMsg() {
            ...
            if ($("#ID").val() != undefined && $("#ID").val() != "") {
                ...
                var Contents = "http://192.168.10.92/PersonalSpace/EmailConrim.aspx?ConfirmID=" + $("#ID").val();
        ...
        function AddConrimEmail() {
            $.ajax({
                ...
                data: {
                    PageName: "CourseManage/PersonSpaceStu.ashx",
                    Func: "AddEmail",
                    Content: $("#EmailID").val(),// "http://192.168.10.92:8085//StudentHandler.ashx?func=UpdateStudent&SystemKey=xlf_self&InfKey=lhsfrz&ID=1&Email =" + $("#EmailID").val() 
