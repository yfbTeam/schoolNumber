...
<script type="text/javascript">
                ...
                if (json.CertificateManage.errNum.toString() == "0") {
                    ...
                    $.each(json.CertificateManage.retData.PagedData, function (n, value) {
                        ...
                        var alink = "<a onclick=\"StuDetail(" + this.ID + ")\">学员信息</a>&nbsp;<a onclick=\"EditCertificate(" + this.ID +
                            ")\">证书修改</a>&nbsp;<a onclick=\"DelCertificate(" + this.ID + ")\">证书删除</a>&nbsp;<a onclick=\"ShowCertificate(" + this.ID + ",'" + CourseName + "','" + ExamName +
                            "','" + this.ImageUrl + "','" + this.Name + "')\">证书预览</a>";
    ...
    function ShowCertificate(ID, CourseName, ExamName, ImageUrl, Name) {
        OpenIFrameWindow('证书预览', 'CertificateShow.aspx?ID=' + ID + "&CourseName=" + CourseName + "&ExamName=" + ExamName + "&ImageUrl=" + ImageUrl + "&Name=" + Name + "&Type=1", '480px', '460px');
    }
</script>
</html>
