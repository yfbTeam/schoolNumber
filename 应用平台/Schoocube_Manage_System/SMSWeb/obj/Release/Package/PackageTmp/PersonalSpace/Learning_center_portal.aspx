            ...
            <div class="courseindex clearfix" style="margin-top: 0px;">
                <div class="fl" style="">
                    <div class="courseindex_left bordshadrad">
                        ...
                        <ul class="allcourses clearfix" id="tb_Cource">
                        </ul>
                        <!--分页-->
                        <div class="page">
                ...
                <div class="studends_center_right fr" style="width: 220px;">
                    ...
                    <div class="courseindex_right bordshadrad mt20" style="height: auto;">
                        ...
                        <ul class="topcourse_list">
                            <li>
                                <a href="">
                                    <p class="topcourse_list_name"><span>1.</span>毕业不说再见</p>
                            ...
                            <li>
                                <a href="">
                                    <p class="topcourse_list_name"><span>2.</span>面试技巧</p>
                            ...
                            <li>
                                <a href="">
                                    <p class="topcourse_list_name"><span>3.</span>给大学生的学习提个醒</p>
                                    <div class="topcourse_list_img">
                                        <img src="/images/tui_03.png" alt="" />
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="">
                                    <p class="topcourse_list_name"><span>4.</span>大学与中心学习大不同</p>
                                    <div class="topcourse_list_img">
                                        <img src="/images/tui_03.png" alt="" />
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="">
                                    <p class="topcourse_list_name"><span>5.</span>学习动力自我诊断测试</p>
                                    <div class="topcourse_list_img">
                                        <img src="/images/tui_03.png" alt="" />
                                    </div>
                                </a>
