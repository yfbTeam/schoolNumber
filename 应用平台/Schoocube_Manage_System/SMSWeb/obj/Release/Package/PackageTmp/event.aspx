    ...
    <script type="text/javascript">
        ...
        function Add() {
            ...
            if (events == '') {
                ...
                $.ajax({
                    ...
                    url: "json.ashx",
                    data: {
                        "PageName": "ResourceManage/MyResourceHander.ashx", "Func": "AddSchedule",
                        Content: events, StartDate: StartDate, EndDate: enddate,
                        IdCard: $("#HUserIdCard").val(), AllDay: AllDay, EndTime: endTime
                    },
                    dataType: "json",
        ...
        function GetDateByID() {
            $.ajax({
                ...
                url: "json.ashx",
                data: {
                    "PageName": "ResourceManage/MyResourceHander.ashx", "Func": "GetSchedule", EditID: $("#EventID").val(), id: $("#EventID").val()
                },
                dataType: "json",
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        $(json.result.retData).each(function () {
                            ...
                            var start_d = startTime.getFullYear() + "-" + startTime.getMonth() + "-" + startTime.getDate();
                            ...
                            var end_d = endtime.getFullYear() + "-" + endtime.getMonth() + "-" + endtime.getDate();
