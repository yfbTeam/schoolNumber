...
<head>
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            <td class="checkradio pr" style="cursor: pointer; color: red" onclick="CourceDetail(${ID});">${Name}</td>
...
<script type="text/javascript">
    ...
    function EditCource(id) {
        OpenIFrameWindow('修改课程', 'CourceAdd.aspx?ID=' + id, '630px', '70%');
    }
    //课程审核
    function Check(id) {
        OpenIFrameWindow('课程审核', 'CourceCheck.aspx?ID=' + id, '630px', '700px');
    }
    ...
    function StuAdjust(id) {
        window.location.href = 'personnel_allotment.aspx?ID=' + id + "&ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName;
    }
    function Modol(id) {
