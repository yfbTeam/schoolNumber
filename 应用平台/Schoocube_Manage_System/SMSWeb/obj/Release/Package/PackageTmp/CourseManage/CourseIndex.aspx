...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function CourceMore() {
            window.location.href = "Cource_More.aspx?ParentID=" + UrlDate.ParentID + "&PageName=" + UrlDate.PageName;
        }
        ...
        function BindData() {
            $.ajax({
                ...
                async: false,
                dataType: "json",
                data: { "PageName": "CourseManage/CourceManage.ashx", "Func": "GetCourseByType" },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        $(json.result.retData).each(function () {
                            ...
                            var div = "<div class=\"team_list fl\" onclick=\"CourseDetail(" + this.ID + ")\"><div class=\"allcourse_img\"><img src='" + ImageUrl
