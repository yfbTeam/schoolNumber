<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course_TaskStatistics.aspx.cs" Inherits="SMSWeb.CourseManage.Course_TaskStatistics" %>
...
<body>
    ...
    <form id="form1" enctype="multipart/form-data" method="post" runat="server">
        <div style="background: #fff">
            <div class="newcourse_dialog_detail">
                <div class="clearfix">
                       <div id="div_task" style="float:left; width: 40%; height: 400px;"></div>                       
                </div>
    ...
    <script>
        ...
        var myChart = echarts.init(document.getElementById('div_task'));
        // 指定图表的配置项和数据
        option = {
            title: {
                text: decodeURIComponent(UrlDate.taskname) + '-任务统计',
                subtext: '',
                x: 'center'
            },
            tooltip: {
            ...
            series: [
                {
                    name: decodeURIComponent(UrlDate.taskname) + '-任务统计',
                    type: 'pie',
                    radius: '55%',
                    center: ['50%', '60%'],
                    data: [
        ...
        function GetComCountByTaskID() {
            $.ajax({
                ...
                data: {
                    ...
                    Func: "GetComCountByTaskID",
                    TaskID: UrlDate.taskid,
                    CourseType: UrlDate.coursetype
                },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        myChart.setOption({ //加载数据图表
                            legend: { data: ['完成任务', '未完成任务'] },
                            series: [{
        ...
        myChart.on('click', function (params) {
            $('#ul_stuContent').html('');
            var iscom = params.name == '未完成任务' ? 0 : 1;
