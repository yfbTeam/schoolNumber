...
$.extend({
    webox: function (option) {
        ...
        $(document).ready(function (e) {
            ...
            $('body').append('<div class="background" style="display:none;"></div><div class="webox" style="width:' + width + 'px;height:' + height + 'px;display:none;"><div id="inside" style="overflow:hidden;height:' + height +
                'px;"><h1 id="locked" onselectstart="return false;">' + (option['title'] ? option['title'] : 'webox') + '<a class="span" href="javascript:void(0);">X</a></h1>' + (option['iframe'] ? '<iframe class="w_iframe" src="' + option['iframe'] + '" frameborder="0" width="100%" scrolling="yes" style="border:none;overflow-x:hidden;height:' + parseInt(height - 38) + 'px;"></iframe>' : option['html'] ? option['html'] : '') + '</div></div>');
            ...
            if (m && !allscreen) {
                ...
                var marginLeft = parseInt(width);
                var marginTop = parseInt(height);
