...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border-radius:3px; border: #0da6ec 1px solid; background: #fff; color: #666; position: fixed; top: 350px; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#bbbbbb,direction=120,strength=4); -moz-box-shadow: 0px 2px 14px #bbbbbb; -webkit-box-shadow: 0px 2px 14px #bbbbbb; box-shadow: 0px 2px 14px #bbbbbb;">'
        inntHtml += '<div id="maskTitle" style="height: 40px; line-height: 40px; font-family: Microsoft Yahei; font-size: 18px; color: #fff; padding-left: 20px; background:#0da6ec; border-shadow: 0 1px 0 #3db8f1; position: relative;">'
        inntHtml += '' + title + ''
        inntHtml += '<div id="popWinClose" style="width: 28px; height: 28px; cursor: pointer; position: absolute; top: 0px; right: 3px; font-size: 16px;">X</div>'
        inntHtml += '</div>'
        inntHtml += '<iframe width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="yes" src="' + src + '"></iframe>';
