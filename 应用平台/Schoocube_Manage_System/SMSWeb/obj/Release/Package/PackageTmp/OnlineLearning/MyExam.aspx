...
<script type="text/javascript">
    ...
    function OnSuccess(json) {
        ...
        mydtim = mydtim.replace("年", "/");
        mydtim = mydtim.replace("月", "/");
        mydtim = mydtim.replace("日", "");
            ...
            $.each(json.result.retData.PagedData, function () {
                ...
                if (str == "学生") {
                    if (this.Statushow == "未阅" && this.typeid != 4) {
                        ...
                        if (this.typeid == 4) { html += "<h2 style=\"width:200px\"><a href='window.open('../Exam/QuestionnaireSurvey .aspx?id=" + this.ID + "');'>" + this.Title + "(可答)</a></h2>"; }
