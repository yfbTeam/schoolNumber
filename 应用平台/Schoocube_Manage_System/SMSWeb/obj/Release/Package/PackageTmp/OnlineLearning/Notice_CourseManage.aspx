...
<head>
    ...
    <script id="tr_notice" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${CreateTime}</td>           
            <td>
                <a href="javascript:;" onclick="javascript: OpenIFrameWindow('修改课程通知', 'Notice_CourseEdit.aspx?itemid=${Id}', '580px', '360px');"><i class="icon icon-edit"></i>修改</a>
            ...
            <div class="course_manage bordshadrad">
                <div class="newcourse_select clearfix">
                    ...
                    <div class="stytem_select_right fr">
                        <a href="javascript:void(0);" class="newcourse"  onclick="javascript: OpenIFrameWindow('添加课程通知','Notice_CourseEdit.aspx?itemid=0', '580px', '360px');"><i class="icon icon-plus"></i>添加</a>
                    </div>
                </div>
                <div class="wrap">
                    <table>
