...
<head runat="server">
    ...
    <style>
        .teacher_left{padding:15px 20px;width:353px;background:#fff;height:152px;}
        .account_balance{padding:15px 20px;background:#fff;width:743px;height:152px;}
        .teacher_names .personal_img{width:146px;height:146px;border:2px solid #bac2c8;border-bottom:none;margin:0 auto;}
        .teacher_names .personal_a{height: 4px;
            background: #1776bd;
            border-radius: 2px;width:170px;}
        .teacher_left .personal_detail{width:163px;}
        .teacher_left .personal_detail .people{text-align:left;}
       .teacher_left .personal_detail .school, .teacher_left .personal_detail .subject{line-height:25px;}
       .account_balance{font-size:18px;color:#555;}
       .account_balancea{text-align:center;width:320px;margin:50px auto;}
       .account_balancea span{display:block;float:left;font-size:16px;color:#666666;height:30px;margin-top:6px;}
       .account_balancea span i{font-size:30px;color:#ff5b00;display:inline-block;margin-left:10px;}
       .account_balancea a{width:96px;height:36px;display:block;text-align:center;line-height:36px;float:left;color:#fff;background:#0074bd;font-size:16px;border:none;border-radius:2px;margin-left:35px;}
       .lastsale{margin-top:20px;}
        .lastsale h1{color:#555;font-size:18px;padding:0px 20px;border-bottom:1px solid #DCDCDC;height:45px;line-height:45px;position:relative;}
        .sale_wrap{display:inline-block;position:absolute;top:12px;left:110px;}
        .sale_wrap span{cursor:pointer;display:block;float:left;width:80px;height:22px;border-right:1px solid #ccc;text-align:center;font-size:16px;color:#0074bd;line-height:22px;}
        .sale_wrap span:last-child{border:none;}
        .sale_record{padding:10px 20px;}
    </style>
    ...
    <div>
        ...
        <div class="onlinetest_item width pt90 clearfix">
            ...
            <div class="clearfix lastsale bordshadrad">
                <h1>最近交易 <div class="sale_wrap">
                    <span>充值记录</span><span>消费记录</span></div></h1>
        ...
        <script>
            ...
            function getData(startIndex, pageSize) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        "PageName": "AccountManagement/UserCardInfoHander.ashx", "Func": "GetPageList", "PageIndex": startIndex, "PageSize": pageSize,  "IdCard": IdCard
                    },
                    success: OnSuccess,
